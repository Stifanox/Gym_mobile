package com.example.gym.exercise_feature.ui.screens.exercise_list_screen.view_models
...
class ExerciseListViewModel @Inject constructor(
    ...
    private val _databaseSaveState: MutableStateFlow<FetchingStatus> =
        MutableStateFlow(FetchingStatus.InProgress)
    val databaseSaveState = _databaseSaveState.asStateFlow()

    private val _databaseDeleteState: MutableStateFlow<FetchingStatus> =
        MutableStateFlow(FetchingStatus.InProgress)
    val databaseDeleteState = _databaseDeleteState.asStateFlow()

    private val _remoteDeleteState: MutableStateFlow<FetchingStatus> =
        MutableStateFlow(FetchingStatus.InProgress)
